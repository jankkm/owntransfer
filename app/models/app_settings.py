...
class AppSettings(Base):
    ...
    primary_color: Mapped[str] = mapped_column(String(32), nullable=False, default="#2563eb")
    accent_color: Mapped[str] = mapped_column(String(32), nullable=False, default="#7c3aed")
    ...
    purge_grace_hours: Mapped[int] = mapped_column(Integer, nullable=False, default=24)
