...
TRANSLATIONS: dict[str | tuple[str, str], str | tuple[str, str]] = {
    ...
    "0 = unlimited downloads.": "0 = accesos ilimitados.",
    "0 = unlimited access.": "0 = accesos ilimitados.",
    ...
    "Files are still being prepared for this upload.": "Los archivos de esta subida aún se están preparando.",
    ...
    "Created": "Creado",
    "Current downloads: %(count)s. Use 0 for unlimited.": "Accesos actuales: %(count)s. Use 0 para ilimitados.",
    "Current access: %(count)s. Use 0 for unlimited.": "Accesos actuales: %(count)s. Use 0 para ilimitados.",
    ...
    "Access limit reached": "Límite de accesos alcanzado",
    ...
    "All available access for this transfer has been used. Contact the person who shared these files if you still need them.": "Se han utilizado todos los accesos disponibles para esta transferencia. Contacte a la persona que compartió estos archivos si aún los necesita.",
    ...
    (
        ...
        "Esta transferencia permite %(max)s acceso. Desbloquear consume un acceso; "
        "después podrá descargar todos los archivos en esta sesión del navegador.",
        "Esta transferencia permite %(max)s accesos. Desbloquear consume un acceso; "
        "después podrá descargar todos los archivos en esta sesión del navegador.",
    ),
    ...
    "Downloads": "Descargas",
    "Access": "Accesos",
    "Unlock access": "Acceso",
    "Link unlocked": "Enlace desbloqueado",
    ...
    "Files from a previous session are shown below.": "Los archivos de una sesión anterior se muestran abajo.",
    "Clear all": "Eliminar todo",
    "Remove blocked or failed files before submitting": "Elimine los archivos bloqueados o fallidos antes de enviar",
    ...
    "Length used by the Generate button on transfer and file request forms. Users cannot change this.": "Longitud usada por el botón Generar en los formularios de transferencias y solicitudes de archivos. Los usuarios no pueden cambiarla.",
    ...
    "Max access cannot be less than current count (%(count)s)": "Los accesos máximos no pueden ser menores que el recuento actual (%(count)s)",
    "Max downloads cannot be negative": "Las descargas máximas no pueden ser negativas",
    "Max access cannot be negative": "Los accesos máximos no pueden ser negativos",
    ...
    "No access recorded yet.": "Aún no hay accesos registrados.",
    ...
    "Recommended: %(n)s characters (set by admin).": "Recomendado: %(n)s caracteres (definido por el administrador).",
    ...
    "Share password length": "Longitud de contraseña para compartidos",
    "Share link": "Enlace de uso compartido",
    "Old share link": "Enlace de uso compartido anterior",
    "New share link": "Nuevo enlace de uso compartido",
    "Share link at deletion": "Enlace de uso compartido al eliminar",
    ...
    "This link has reached its access limit and is not publicly accessible until you raise the limit.": "Este enlace ha alcanzado su límite de accesos y no es accesible públicamente hasta que aumente el límite.",
    ...
    "Use 0 for unlimited access.": "Use 0 para accesos ilimitados.",
    ...
    "Default max access": "Accesos máx. predeterminados",
    ...
    "Password must be at least %(n)s characters": "La contraseña debe tener al menos %(n)s caracteres",
    ...
    "Protected (changed)": "Protegido (cambiado)",
    "Password protection": "Protección con contraseña",
    "Transfer created": "Transferencia creada",
    "Transfer updated": "Transferencia actualizada",
    "File added": "Archivo añadido",
    "File removed": "Archivo eliminado",
    "Share link regenerated": "Enlace de compartición regenerado",
    "Owner changed": "Propietario cambiado",
    "Transfer deleted": "Transferencia eliminada",
    "Transfer auto-deleted after expiry": "Transferencia eliminada automáticamente tras caducar",
    "File request created": "Solicitud de archivos creada",
    "File request updated": "Solicitud de archivos actualizada",
    "Files uploaded": "Archivos subidos",
    "File request deleted": "Solicitud de archivos eliminada",
    "File request auto-deleted after expiry": "Solicitud eliminada automáticamente tras caducar",
    "All files (ZIP)": "Todos los archivos (ZIP)",
    "ZIP download": "Descarga ZIP",
    "File download": "Descarga de archivo",
    "%(type)s: %(file)s": "%(type)s: %(file)s",
    "Files uploaded (%(count)s)": "Archivos subidos (%(count)s)",
    ("%(count)s event", "%(count)s events"): ("%(count)s evento", "%(count)s eventos"),
    ...
    "By": "Por",
    "Archive record deleted.": "Registro de archivo eliminado.",
    "Archive record not found": "Registro de archivo no encontrado",
    "Keep in archive (days)": "Conservar en archivo (días)",
    "Archived metadata is removed after this many days. 0 = never auto-delete.": "Los metadatos archivados se eliminan después de este número de días. 0 = nunca eliminar automáticamente.",
    "System audit log": "Registro de auditoría del sistema",
    "Share activity is shown on each transfer or file request and in the archive.": "La actividad de la compartición se muestra en cada transferencia o solicitud y en el archivo.",
    "Archive": "Archivo",
    "Archived": "Archivado",
    "Deleted by user": "Eliminado por el usuario",
    "Auto-deleted after expiry": "Eliminado automáticamente tras caducar",
    "Auto-purged": "Purgado automáticamente",
    "Files at deletion": "Archivos al eliminar",
    "Remove archive record": "Eliminar registro de archivo",
    "Permanently delete this archive entry. File data is already removed; this only erases the metadata record.": "Eliminar permanentemente este registro de archivo. Los datos de archivos ya fueron eliminados; esto solo borra el registro de metadatos.",
    "Delete archive record?": "¿Eliminar registro de archivo?",
    "This metadata record will be permanently removed.": "Este registro de metadatos se eliminará permanentemente.",
    "Deleted shares": "Comparticiones eliminadas",
    "Archive (%(count)s)": "Archivo (%(count)s)",
    "No archived shares found.": "No se encontraron comparticiones archivadas.",
    "Back to archive": "Volver al archivo",
    "Reason": "Motivo",
    "Activity": "Actividad",
    "View": "Ver",
    "Instructions": "Instrucciones",
    "Cannot exceed the system limit of %(max)s MB.": "No puede superar el límite del sistema de %(max)s MB.",
    "Invalid owner": "Propietario no válido",
    "Could not update file request": "No se pudo actualizar la solicitud de archivos",
    "Could not create file request": "No se pudo crear la solicitud de archivos",
    "Color scheme must be a hex color like #2563eb": "El esquema de color debe ser un color hexadecimal como #2563eb",
    "Too many failed password attempts. Try again later.": "Demasiados intentos de contraseña fallidos. Inténtelo más tarde.",
    "Max total size cannot exceed the system limit (%(max_mb)s MB)": "El tamaño total máximo no puede superar el límite del sistema (%(max_mb)s MB)",
    "Upload is still being prepared": "La subida aún se está preparando",
    "Notify on download": "Notificar al descargar",
    "Max total size (MB)": "Tamaño total máx. (MB)",
    "Uploader": "Subidor",
    "No uploads recorded yet.": "Aún no hay subidas registradas.",
    "Default max uploads": "Subidas máx. predeterminadas",
    "0 = unlimited uploads.": "0 = subidas ilimitadas.",
    "Transfer": "Transferencia",
    "File request": "Solicitud de archivos",
    "Delete archive record": "Eliminar registro de archivo",
    "Delete this archive record?": "¿Eliminar este registro de archivo?",
    "Yes, delete record": "Sí, eliminar registro",
    "Fill with built-in:": "Rellenar con plantilla:",
    "Menu": "Menú",
    (
